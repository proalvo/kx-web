...
-- ---------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS kx_schema_migration (
...
-- ---------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS kx_organization (
...
CREATE TABLE IF NOT EXISTS kx_app_user (                      -- "user" is reserved-ish; avoid quoting
...
CREATE TABLE IF NOT EXISTS kx_org_user (
  org_id   CHAR(36) NOT NULL,
  user_id  CHAR(36) NOT NULL,
  role     ENUM('org_admin','editor') NOT NULL DEFAULT 'editor',
  PRIMARY KEY (org_id, user_id),
  KEY idx_org_user_user (user_id),
  CONSTRAINT fk_org_user_org  FOREIGN KEY (org_id)  REFERENCES kx_organization (org_id) ON DELETE CASCADE,
  CONSTRAINT fk_org_user_user FOREIGN KEY (user_id) REFERENCES kx_app_user (user_id)    ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- ---------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS kx_competition (
  ...
  banner_url      VARCHAR(500) NULL,                        -- optional: public URL for competition banner
  created_at      DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  ...
  CONSTRAINT fk_competition_org FOREIGN KEY (org_id) REFERENCES kx_organization (org_id) ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- ---------------------------------------------------------------------
-- Event within a competition (e.g. K1M, K1W)
-- ---------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS kx_event (
  ...
  CONSTRAINT fk_event_competition FOREIGN KEY (competition_id)
    REFERENCES kx_competition (competition_id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- ---------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS kx_phase (
  ...
  CONSTRAINT fk_phase_event FOREIGN KEY (event_id) REFERENCES kx_event (event_id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- ---------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS kx_phase_entry (
  ...
  CONSTRAINT fk_entry_phase FOREIGN KEY (phase_id) REFERENCES kx_phase (phase_id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- ---------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS kx_sync_log (
...
-- ---------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS kx_rate_limit (
...
INSERT IGNORE INTO kx_schema_migration (version) VALUES (1), (2), (3), (4);
